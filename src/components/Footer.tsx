        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          <div className="col-span-1 lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              Transform your fitness journey with AI-powered motion tracking, personalized workouts, and a supportive community.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Workout Library</a></li>
              ...
              <li><a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Success Stories</a></li>
            </ul>
          </div>
          <div>
