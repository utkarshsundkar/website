      ...
      <section className="bg-[#F6FBE9] py-12 md:py-16 px-4 md:px-8 lg:px-20 relative">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="space-y-4 md:space-y-6">
            <span className="text-xs uppercase font-medium text-[#468671] tracking-wider">
              Transform Your Fitness Journey with
            </span>

            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#1A3129] leading-tight">
              AI-Powered Motion Tracking for Smarter Home Workouts
            </h1>
            ...
            <div className="flex gap-4">
              <a
                ...
                aria-label="Start your Arthlete journey by filling out the form"
            ...
            <div className="flex items-center gap-4 mt-4 md:mt-8">
              <div className="flex -space-x-3">
                <img
                  ...
                  alt="Arthlete user testimonial 1"
                ...
                <img
                  ...
                  alt="Arthlete user testimonial 2"
                  className="w-8 h-8 md:w-10 md:h-10 rounded-full border-2 border-white"
                />
                <img
                  ...
                  alt="Arthlete user testimonial 3"
                  className="w-8 h-8 md:w-10 md:h-10 rounded-full border-2 border-white"
                />
              </div>
              <div>
          ...
          <div className="flex justify-center md:justify-end">
            <img
              ...
              alt="Screenshot of Arthlete AI fitness app home screen"
